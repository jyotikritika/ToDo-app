...
class Card extends React.Component {
  ...
  componentDidMount() {
    ...
    arrayIdf === null
      ...
      : this.setState({ arraySize: arrayIdf });
  ...
  addNewTask = e => {
    ...
    console.log(
      "add new task method called. array size now is: ",
  ...
  render() {
    ...
    return (
      <div className="card">
        <div className="dateHeader">{this.getCurrentDate()}</div>
        <hr />
        ...
        <div className="content">
          {this.state.taskArray.length > 0 ? (
            ...
            <div className="listItem">Go and add some new Task!</div>
          )}
